...
- (instancetype)initWithAccount:(NSString * _Nullable)account token:(NSString * _Nullable) token sendVerCodeType:(MNWSendVerCodeType)type phone:(NSString *)phone phoneAreaCode:(NSString *)phoneAreaCode;
...
/// @param email  邮箱
- (instancetype)initWithAccount:(NSString * _Nullable)account token:(NSString * _Nullable) token sendVerCodeType:(MNWSendVerCodeType)type email:(NSString *)email;
